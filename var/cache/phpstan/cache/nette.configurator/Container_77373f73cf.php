...
class Container_77373f73cf extends _PHPStan_9a6ded56a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService039(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_77373f73cf $container)
			{
	...
	public function createServiceContainer(): Container_77373f73cf
	{
		return $this;
	}
